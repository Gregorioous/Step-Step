...
import com.step.step_step.core.presentation.MainActivity
...
class StepCounterService : LifecycleService(), SensorEventListener {
    ...
    companion object {
        private const val NOTIFICATION_CHANNEL_ID = "step-step_counter_channel"
    ...
    override fun onCreate() {
        ...
        val application = application as StepApplication
    ...
    private fun createNotification(state: StepCounterState): Notification = state.run {
        ...
        NotificationCompat.Builder(this@StepCounterService, NOTIFICATION_CHANNEL_ID)
            ...
            .setSmallIcon(R.drawable.steps_fill0_wght400_grad0_opsz24)
    ...
    @RequiresApi(Build.VERSION_CODES.O)
    private fun registerNotificationChannel(chanel: NotificationChannel) {
        val notificationManager = getSystemService(NOTIFICATION_SERVICE) as NotificationManager
